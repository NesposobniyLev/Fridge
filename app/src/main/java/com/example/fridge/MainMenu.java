...
public class MainMenu extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        ((AppCompatActivity)getActivity()).getSupportActionBar().setTitle("Мой холодильник");
        ...
        fab2.setOnClickListener(view12 -> NavHostFragment.findNavController(MainMenu.this)
                .navigate(R.id.action_FirstFragment_to_SixthFragment));
        view.findViewById(R.id.button_first).setOnClickListener(view13 -> NavHostFragment.findNavController(MainMenu.this)
                .navigate(R.id.action_FirstFragment_to_SecondFragment));
        view.findViewById(R.id.button_first3).setOnClickListener(view14 -> NavHostFragment.findNavController(MainMenu.this)
                .navigate(R.id.action_FirstFragment_to_ThirdFragment));
        view.findViewById(R.id.button_first2).setOnClickListener(view15 -> NavHostFragment.findNavController(MainMenu.this)
                .navigate(R.id.action_FirstFragment_to_FifthFragment));
        view.findViewById(R.id.fab3).setOnClickListener(view16 -> NavHostFragment.findNavController(MainMenu.this)
