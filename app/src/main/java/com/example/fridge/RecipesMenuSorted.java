...
public class RecipesMenuSorted extends Fragment {
    ...
    public void addProductToList(String name, int count, int accepted){
        ...
        b.setOnClickListener(v -> {
            ...
            edit.apply();
            NavHostFragment.findNavController(RecipesMenuSorted.this).navigate(R.id.action_FifthFragment_to_FourthFragment);
        });
    }
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        ((AppCompatActivity)getActivity()).getSupportActionBar().setTitle("Подобранные рецепты");
        ...
        try {
            ...
            obj = new JSONObject(Recipe.readJSONFromAsset(is));
